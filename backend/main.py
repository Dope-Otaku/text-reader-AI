...
'''
this function is used to get the text from the pdf file and returns text
'''
...
'''
this function is used to split the text into chunks and returns chunks
'''
...
'''
this function is used to get the vectorstore and returns vectorstore
'''
...
# this is the upload file endpoint
@app.post("/uploadfile/")
...
'''
this function is used to handle the user input and returns the response
'''
def get_conversation_chain(vectorstore):
    llm = ChatOpenAI()
    memory = ConversationBufferMemory(memory_key='chat_history', return_messages=True)
...
# this is the ask question endpoint
...
'''
this function is used to handle the user input and returns the response and app.vectorstore is used to check if the vectorstore is initialized or not
'''
